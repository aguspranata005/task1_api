...
func (s *CategoriesService) GetAll() ([]models.Barang, error) {
	return s.repo.GetAll()
}

func (s *CategoriesService) Create(data *models.Barang) error {
	return s.repo.Create(data)
}

func (s *CategoriesService) GetByID(id int) (*models.Barang, error) {
	return s.repo.GetByID(id)
}

func (s *CategoriesService) Update(categories *models.Barang) error {
